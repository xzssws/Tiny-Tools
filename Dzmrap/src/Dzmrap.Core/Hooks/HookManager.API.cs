...
namespace Dzmrap.Hooks
{
    ...
    public static partial class HookManager
    {
        ...
        /// <summary>
        /// 在Windows NT /2000 / XP：安装，监控低级别的鼠标输入事件的一个钩子程序。
        /// </summary>
        private const int WH_MOUSE_LL = 14;

        /// <summary>
        /// 在Windows NT /2000/ XP：安装，监控低级别的键盘输入事件一个钩子程序。
        /// </summary>
        ...
        /// <summary>
        /// 该WM_MOUSEMOVE消息发布到一个窗口，当光标移动。
        /// </summary>
        private const int WM_MOUSEMOVE = 0x200;

        /// <summary>
        /// 当用户按下鼠标左键的WM_LBUTTONDOWN消息发布
        /// </summary>
        private const int WM_LBUTTONDOWN = 0x201;

        /// <summary>
        /// 当用户按下鼠标右键的WM_RBUTTONDOWN消息发布
        /// </summary>
